...
def get_common_args():
    ...
    parser.add_argument('--obs_space', type=int, default=10, help='observation space')
    parser.add_argument('--state_space', type=int, default=10, help='observation space')

    parser.add_argument('--action_space', type=int, default=3, help='action space')
    parser.add_argument('--num_actions', type=int, default=2, help='number of agents')
